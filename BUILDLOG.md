...
- With Pitch back, pitching Marcellina again failed with "A draft of this document already exists", because the slugged id was the spiked story's. A new pitch is a new story, so the id gets `-2` when the slug is taken.
